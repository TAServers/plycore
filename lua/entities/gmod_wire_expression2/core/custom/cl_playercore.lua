...
desc(
	"plySetPos",
	"Sets the position of the player within the bounds of the map"
)
...
desc(
	"plySetHealth",
	"Sets the health of the player within the positive range of int32"
)
...
desc(
	"plySetArmor",
	"Sets the armour of the player within the positive range of int32"
)
...
desc(
	"plySetGravity",
	"Sets the raw gravity value for the player (default: 600)"
)
desc(
	"plySetGravityMul",
	"Sets the multiplier for the player's gravity (gravity = 600 * mul, default: 1)"
)
...
desc(
	"plySetSpeed",
	"Sets the overall speed of the player (walk = speed, run = speed * 2, default: 200)"
)
desc("plySetWalkSpeed", "Sets the player's walk speed (default: 200)")
desc("plySetRunSpeed", "Sets the player's run speed (default: 400)")
desc(
	"plyGetSpeed",
	"Gets the overall speed of the player (this is equal to plyGetWalkSpeed)"
)
...
desc(
	"plyIgnite(n)",
	"Sets the player on fire for the specified number of seconds"
)
...
desc(
	"sendMessageCenter",
	"Sends a message to the centre of every player's screen"
)
desc(
	"sendMessageCentre",
	"Sends a message to the centre of every player's screen"
...
desc(
	"e:sendMessageCenter",
	"Sends a message to the centre of the player's screen"
)
desc(
	"e:sendMessageCentre",
	"Sends a message to the centre of the player's screen"
...
desc(
	"a:sendMessageCenter",
	"Sends a message to the centre of every player in the array's screen"
)
desc(
	"a:sendMessageCentre",
	"Sends a message to the centre of every player in the array's screen"
...
desc(
	"a:sendMessageColor",
	"Sends a coloured message to every player in the array's chatbox"
)
desc(
	"a:sendMessageColour",
	"Sends a coloured message to every player in the array's chatbox"
...
desc(
	"lastDeathInflictor",
	"Returns the entity that caused the last player death"
)
desc(
	"lastDeathAttacker",
	"Returns the player that killed the last player that died"
)
...
desc(
	"disconnectClk",
	"Returns 1 if this execution was caused by a player joining"
)
